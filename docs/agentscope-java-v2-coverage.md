...
| FAQ / Readiness notes | https://java.agentscope.io/v2/zh/docs/others/faq.html | v2 / 2026-06-09 | `agentscope-v2-complete-coverage` | 文档/接口：作为覆盖矩阵复核入口 | 由 `scripts/validate-agentscope-coverage.mjs` 校验矩阵必填项和基线日期 |
