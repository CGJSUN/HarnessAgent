...
class EnterpriseHarnessAgentRuntimeTest {
    ...
    void mapsFineGrainedToolAndHitlEvents() {
        AgentRuntimeEvent toolStart = EnterpriseHarnessAgentRuntime.toRuntimeEvent(
                new ToolCallStartEvent("reply-1", "call-1", "search.docs"));
        AgentRuntimeEvent waitingConfirmation = EnterpriseHarnessAgentRuntime.toRuntimeEvent(
    ...
    void mapsSubagentEventsAndSourcedResults() {
        AgentRuntimeEvent exposed = EnterpriseHarnessAgentRuntime.toRuntimeEvent(
                new SubagentExposedEvent("sub-1", "researcher", "session-sub", "Researcher"));
        AgentRuntimeEvent sourcedResult = EnterpriseHarnessAgentRuntime.toRuntimeEvent(
    ...
    void mapsTextDeltaAndTopLevelResult() {
        AgentRuntimeEvent delta = EnterpriseHarnessAgentRuntime.toRuntimeEvent(
                new TextBlockDeltaEvent("reply-1", "block-1", "hello"));
        AgentRuntimeEvent done = EnterpriseHarnessAgentRuntime.toRuntimeEvent(
    ...
    void fallsBackToConfiguredProviderWhenPrimaryModelFails() {
        ...
        EnterpriseHarnessAgentRuntime runtime = new EnterpriseHarnessAgentRuntime(
                properties,
        ...
        AgentReply reply = runtime.complete(new AgentRunRequest(
                        new RuntimeContextFactory().create("tenant-a", "user-a", "agent-a", "session-a"),
